...
import { FaqSection } from "@/components/downloader/FaqSection";
  ...
  const handleSubmit = (url: string) => {
    ...
    getVideoInfo.mutate(
      { data: { url } },
      {
        ...
        onError: (err: any) => {
          setErrorMsg(err?.response?.data?.error || "Failed to fetch video information. Please check the URL and try again.");
        }
      }
    );
  };
